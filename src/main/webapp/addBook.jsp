...
<div class="container">
  <form action="/Library/books/book/add" method="post">
    <div class="row">
      <div class="col-25">
        <label for="fname">Book Name</label>
      </div>
      <div class="col-75">
        <input type="text" id="name" name="name" placeholder="Java">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="author" name="author" placeholder="R.S.Aggarwal">
      </div>
    </div>
        <br>
    <div class="row">
